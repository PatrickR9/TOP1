...
@switch($selectedFunction)
    ...
    <div class = "management_top_center_block">
        ...
        <ul class = "management_top_history_block">
        ...
        <li wire:click="reloadVersion('{{$versionType}}', '{{$versionNumber}}')"><span class = "li_label_date">{{$versionType}}.{{$versionNumber}} {{$version['date']}}</span><span class = "li_label_date">{{$version['time']}}</span></li>
                @endforeach
            @endforeach
        @endforeach
        </ul>
